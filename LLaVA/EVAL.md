...
1. Download validation images: Extract [`val.zip`](https://vizwiz.cs.colorado.edu/VizWiz_final/images/val.zip) to `val`. Put it under `./playground/data/eval/vizwiz`.
2. Download validation annotations: Extract [`val.json`](https://vizwiz.cs.colorado.edu/VizWiz_final/vqa_data/Annotations.zip) to `./playground/data/eval/vizwiz`.
...
2. Download [`val2014`](http://images.cocodataset.org/zips/val2014.zip) images, extract them, and put the `val2014` folder under `./playground/data/eval/pope`.
