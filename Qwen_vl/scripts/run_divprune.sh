#!/usr/bin/env bash
# Public DivPrune evaluation script for Qwen-VL.
...
run_task() {
    ...
    local model_name="${MODEL_PREFIX}-DivPruner-${token_num}"
    local tag="divprune_${MODEL_FAMILY}_t${token_num}_${dataset_name}"
