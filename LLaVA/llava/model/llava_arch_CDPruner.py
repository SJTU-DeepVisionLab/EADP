...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images, texts=None):
        image_features, image_embeds, text_embeds, _ = self.get_model().get_vision_tower()(images, texts=texts)
        ...
        # [Visualization Hook] Cache global instruction relevance for paper figures
        self.relevance_cache = relevance.detach().cpu()
