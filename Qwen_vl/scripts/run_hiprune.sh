#!/usr/bin/env bash
# Public HiPrune evaluation script for Qwen-VL.
...
run_task() {
    ...
    local model_name="${MODEL_PREFIX}-HiPrune-${token_num}"
    local tag="hiprune_${MODEL_FAMILY}_t${token_num}_${dataset_name}"
